...
Stats.prototype.aborted = function (mapname) {
	this.maps[mapname].aborted++;
};
...
Stats.prototype.validateMapStat = function (mapname) {
	this.maps[mapname] = this.maps[mapname] || {requested: 0, served: 0, processed: 0, missing: 0, current: 0, aborted: 0};
};
