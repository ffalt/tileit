				...
				"rules": [
					{
						...
						"symbolizers": [
							...
							},
							{
								...
								'spacing': '100', //default: "100"
								'max-error': '0.2', //default: "0.2"
								'placement':'point', //default: "point"
								'ignore-placement':'false', //default: "false"
								'marker-type': 'ellipse', // default: "arrow" if placement:line, "ellipse" if placement:point
								//'file': './dummy/svg.svg', // svg marker
								//'transform':'scale(2)', //svg transfom
								'fill': '#ffffff', // background if NOT svg
								'stroke': '#000000', // border color, default:"black"
								'stroke-width': '1.0',  //border width, default:"1.0"
								'stroke-opacity': '1.0', //border opacity, default:"1.0"
								'allow-overlap': 'false', //default: "false"
	...
	var symbolizerToXML = function (symb) {
		switch (symb.type) {
			...
			case 'text':
				...
				break;
			case 'marker':
				return '<MarkersSymbolizer' + attrs(symb, ['type']) + ' />';
				break;
		}
		return '';
	};
